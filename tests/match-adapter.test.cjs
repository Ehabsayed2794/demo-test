...
(function () {
  ...
  // ============================================================
  var fs = require("fs");
  var adapterSource = fs.readFileSync(REPO_ROOT + "/design-ui/match-adapter.js", "utf8");
  ...
  var adapterSourceForRules = fsCheck.readFileSync(REPO_ROOT + "/design-ui/match-adapter.js", "utf8");
  ...
  var TableEngineRealExports = require("fs").readFileSync(REPO_ROOT + "/design-ui/engine/table-engine.js", "utf8");
  ...
  var adapterSourceForTrick = require("fs").readFileSync(REPO_ROOT + "/design-ui/match-adapter.js", "utf8");
