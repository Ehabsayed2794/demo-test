...
> **SUPERSEDED IN PART by Sprint 3.6.1** (`docs/reviews/MatchFlowIntegration_3.6.1.md`) — §3's Normal Dash scoring bug, described below as "NOT FIXED," **was fixed** in Sprint 3.6.1. This document is left otherwise unchanged, per this project's "document deviations, don't hide them" convention — read the addendum for the exact fix, why it was correct to fix at the source rather than downstream, and the regression coverage added for Sa'ayda/With/Without/Mixed rounds.
...
## 3. Discovered Bug: Normal Dash (0-estimate) Corrupts Scoring — NOT FIXED (at the time of this report — FIXED in Sprint 3.6.1, see the notice at the top of this document)
