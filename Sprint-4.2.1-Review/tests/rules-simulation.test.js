...
function isValidCardSubmission(oldData, newData, requestAuthUid) {
  ...
  if (!("seats" in oldData) || !("cardLog" in oldData) || !("version" in oldData)) return false;

  var allowedChangedKeys = ["cardLog", "lastCardSeat", "version", "updatedAt"];
  ...
  if (!(appendedKeys.length === 2 && appendedKeys.indexOf("seatId") !== -1 && appendedKeys.indexOf("card") !== -1)) return false;
...
var matchAfterCreate42 = validNewMatch42;

check(
  "SIMULATED — card submission (valid card): seat owner appends one well-formed card — ALLOWED",
  isValidCardSubmission(
    matchAfterCreate42,
    Object.assign({}, matchAfterCreate42, { cardLog: [{ seatId: "p1", card: { suit: "SPADES", rank: { v: 12, s: "Q" } } }], version: 2, lastCardSeat: "p1" }),
    "userB"
  ) === true
);
check(
  "SIMULATED — multiple sequential cards: a second, independent append after the first is ALSO allowed",
  isValidCardSubmission(
    Object.assign({}, matchAfterCreate42, { cardLog: [{ seatId: "p1", card: { suit: "SPADES", rank: { v: 12, s: "Q" } } }], version: 2, lastCardSeat: "p1" }),
    Object.assign({}, matchAfterCreate42, {
      cardLog: [{ seatId: "p1", card: { suit: "SPADES", rank: { v: 12, s: "Q" } } }, { seatId: "p2", card: { suit: "SPADES", rank: { v: 5, s: "5" } } }],
      version: 3, lastCardSeat: "p2"
    }),
    "userC"
  ) === true
);
check(
  ...
  isValidCardSubmission(
    matchAfterCreate42,
    Object.assign({}, matchAfterCreate42, { cardLog: [{ seatId: "p2", card: { suit: "SPADES", rank: { v: 12, s: "Q" } } }], version: 2, lastCardSeat: "p2" }),
...
check(
  ...
  isValidCardSubmission(
    matchAfterCreate42,
    Object.assign({}, matchAfterCreate42, { cardLog: [{ seatId: "p2", card: { suit: "SPADES", rank: { v: 12, s: "Q" } } }], version: 2, lastCardSeat: "p1" }),
    "userB"
  ) === false
);
check(
  ...
  isValidCardSubmission(
    matchAfterCreate42,
    Object.assign({}, matchAfterCreate42, { cardLog: [{ seatId: "p1", card: { suit: "SPADES", rank: { v: 12, s: "Q" } } }], version: 5, lastCardSeat: "p1" }),
    "userB"
  ) === false
);
check(
  ...
  isValidCardSubmission(
    matchAfterCreate42,
    Object.assign({}, matchAfterCreate42, { cardLog: [{ seatId: "p1", card: { suit: "SPADES", rank: { v: 12, s: "Q" } } }], version: 1, lastCardSeat: "p1" }),
    "userB"
  ) === false
);
check(
...
check(
  ...
  isValidCardSubmission(
    matchAfterCreate42,
    Object.assign({}, matchAfterCreate42, { version: 2, lastCardSeat: "p1" }),
    "userB"
  ) === false
);
check(
  "SIMULATED — SECURITY: a field outside {cardLog, lastCardSeat, version, updatedAt} changes in the same write — DENIED",
  isValidCardSubmission(
    matchAfterCreate42,
    Object.assign({}, matchAfterCreate42, { cardLog: [{ seatId: "p1", card: { suit: "SPADES", rank: { v: 12, s: "Q" } } }], version: 2, lastCardSeat: "p1", turn: "userC" }),
    "userB"
  ) === false
);
...
function cardSubmissionWith(card) {
  return Object.assign({}, matchAfterCreate42, { cardLog: [{ seatId: "p1", card: card }], version: 2, lastCardSeat: "p1" });
}
  ...
  isValidCardSubmission(
    ...
    Object.assign({}, prefixRewriteMatch, {
      cardLog: [
        ...
        { seatId: "p2", card: { suit: "SPADES", rank: { v: 5, s: "5" } } },
        { seatId: "p1", card: { suit: "SPADES", rank: { v: 8, s: "8" } } } // the one genuinely new, well-formed entry
      ],
      version: 4, lastCardSeat: "p1"
    }),
  ...
  isValidCardSubmission(
    ...
    Object.assign({}, prefixRewriteMatch, {
      cardLog: [
        ...
        { seatId: "p1", card: { suit: "SPADES", rank: { v: 12, s: "Q" } } },
        { seatId: "p1", card: { suit: "SPADES", rank: { v: 8, s: "8" } } }
      ],
      version: 4, lastCardSeat: "p1"
    }),
    "userB"
